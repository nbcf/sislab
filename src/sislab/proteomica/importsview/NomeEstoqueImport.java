 ...
 * @author NILDO
 */
public class NomeEstoqueImport extends JPanel {
      private static JFrame frameNomeEstoqueImport;
      Container cont = new Container();
    public NomeEstoqueImport() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idNomeEstoque}"));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(masterScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 714, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.MouseListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == refreshButton) {
                NomeEstoqueImport.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == jButton3) {
                NomeEstoqueImport.this.jButton3ActionPerformed(evt);
            }
            else if (evt.getSource() == jButton1) {
                NomeEstoqueImport.this.jButton1ActionPerformed(evt);
            }
        }

        public void mouseClicked(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == masterTable) {
                NomeEstoqueImport.this.masterTableMouseClicked(evt);
            }
        }
  ...
  TipoEstoqueView.tps.setJtf_idNomeEstoque((Integer)masterTable.getValueAt(masterTable.getSelectedRow(), 0));
  TipoEstoqueView.tps.setJtf_nomeEstoque((String)masterTable.getValueAt(masterTable.getSelectedRow(), 1));
  TipoEstoqueView.tps.setJtf_laboratorio((String)masterTable.getValueAt(masterTable.getSelectedRow(), 2));
  TipoEstoqueView.tps.setJtf_localizacao((String)masterTable.getValueAt(masterTable.getSelectedRow(), 3));
  TipoEstoqueView.tps.setJtf_sala((String)masterTable.getValueAt(masterTable.getSelectedRow(), 4));
  TipoEstoqueView.tps.setJtf_idLab((String)masterTable.getValueAt(masterTable.getSelectedRow(), 5));
  TipoEstoqueView.tps.setJtf_idLocal((String)masterTable.getValueAt(masterTable.getSelectedRow(), 6));
  frameNomeEstoqueImport.dispose();
  ...
  frameNomeEstoqueImport.dispose();
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                frameNomeEstoqueImport = new JFrame();
                frameNomeEstoqueImport.setContentPane(new NomeEstoqueImport());
                frameNomeEstoqueImport.setSize(714, 492);//[]
                frameNomeEstoqueImport.setResizable(false);
                frameNomeEstoqueImport.setLocationRelativeTo(null);
                frameNomeEstoqueImport.pack();
                frameNomeEstoqueImport.setVisible(true);
                frameNomeEstoqueImport.setTitle(args[0]);
            }
        });
    }
